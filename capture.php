...
$conn = new mysqli($servername, $username, $password,$dbname);
    ...
    if(!@$_POST['submit']) {
        ...
        mysql_query("INSERT INTO vehicle_info('VEHICLE_REGNO','vehicle_name','capacity', 'Owner_ID','Driver_ID','Route_Name','Sacco_Name') VALUES(NULL, '$regno', '$name', '$capacity', '$Ownerid', '$DId', '$route', '$sacco')") or die(mysql_error());
